...
class assign extends Expression {
    ...
    public void code(PrintStream s, CgenClassTable cgenTable) {
        ...
        // Cool Manual 7.2
        // "Identifier self may be referenced, but it is an error to
        // assign to self or to bind self in a let, a case, or
        // as a formal parameter. It is also illegal to have attributes
        // named self"
...
class dispatch extends Expression {
    ...
    public void code(PrintStream s, CgenClassTable cgenTable) {
        ...
        if (exprType.equals(TreeConstants.SELF_TYPE)) {
            ...
            exprType = CgenNode.getLatestType();
